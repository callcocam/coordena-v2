...
return [
    ...
    | de validação. Algumas regras possuem múltiplas versões, como as regras de
    | tamanho. Sinta-se à vontade para ajustar cada mensagem aqui.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui você pode especificar mensagens de validação personalizadas usando a
    | convenção "attribute.rule" para nomear as linhas. Isso agiliza a definição
    | de uma linha específica para uma regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para trocar o marcador :attribute por algo
    | mais amigável, como "Endereço de e-mail" em vez de "email".
    |
    */
