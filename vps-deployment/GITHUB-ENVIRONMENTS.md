...
| `GHCR_REPO` | `callcocam/coordena-v2` | `vps-build-push` (push da imagem) |
...
gh secret set SSH_PRIVATE_KEY --repo "${REPO}" --env production < ~/.ssh/id_ed25519_coordena-v2_deploy
