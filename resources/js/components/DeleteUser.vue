...
<template>
    <div class="space-y-6">
        <Heading
            variant="small"
            title="app.settings.delete_account.heading"
            description="app.settings.delete_account.heading_desc"
        />
        <div
                    ...
                    >
                        ...
                        <div class="grid gap-2">
                            <Label for="password" class="sr-only">{{
                                t('app.settings.delete_account.password')
                            }}</Label>
                            <PasswordInput
                                id="password"
                                name="password"
                        ...
                        <DialogFooter class="gap-2">
                            ...
                            >
                                {{ t('app.settings.delete_account.confirm') }}
                            </Button>
                        </DialogFooter>
                    </Form>
                </DialogContent>
