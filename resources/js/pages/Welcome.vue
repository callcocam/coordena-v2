...
<template>
    <Head :title="t('app.marketing.welcome.meta_title')">
    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                ...
                >
                    {{ t('app.marketing.welcome.nav.dashboard') }}
                </Link>
                <template v-else>
                    <Link
                        :href="login()"
                    ...
                    >
                        {{ t('app.marketing.welcome.nav.login') }}
                    </Link>
                    <Link
                        :href="register()"
                        class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                    >
                        {{ t('app.marketing.welcome.nav.register') }}
                    </Link>
                </template>
            </nav>
        </header>
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">
                        {{ t('app.marketing.welcome.get_started.title') }}
                    </h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        {{ t('app.marketing.welcome.get_started.description') }}
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                {{
                                    t(
                                        'app.marketing.welcome.get_started.docs_prefix',
                                    )
                                }}
                                <a
                                ...
                                >
                                    <span>{{
                                        t(
                                            'app.marketing.welcome.get_started.docs_link',
                                        )
                                    }}</span>
                                    <svg
                                        width="10"
                        ...
                        >
                            ...
                            <span>
                                {{
                                    t(
                                        'app.marketing.welcome.get_started.laracasts_prefix',
                                    )
                                }}
                                <a
                                ...
                                >
                                    <span>{{
                                        t(
                                            'app.marketing.welcome.get_started.laracasts_link',
                                        )
                                    }}</span>
                                    <svg
                                        width="10"
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            ...
                            >
                                {{ t('app.marketing.welcome.get_started.deploy') }}
                            </a>
                        </li>
                    </ul>
                </div>
