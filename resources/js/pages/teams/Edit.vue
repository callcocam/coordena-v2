...
const pageTitle = computed(() =>
    props.permissions.canUpdateTeam
        ? t('app.teams.edit.title_edit', { name: props.team.name })
...
<template>
    ...
    <div class="flex flex-col space-y-10">
        ...
        <div v-if="permissions.canUpdateTeam" class="space-y-6">
            <Heading
                variant="small"
                title="app.teams.edit.settings_title"
                description="app.teams.edit.settings_description"
            />
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <Heading
                    variant="small"
                    title="app.teams.members.title"
                    :description="
                        permissions.canCreateInvitation
                            ? 'app.teams.members.description'
                            : ''
                    "
                />
        ...
        <div v-if="invitations.length > 0" class="space-y-6">
            <Heading
                variant="small"
                title="app.teams.invitations.title"
                description="app.teams.invitations.description"
            />
        ...
        >
            <Heading
                variant="small"
                title="app.teams.delete.title"
                description="app.teams.delete.description"
            />
            <div
            ...
            >
                ...
                <Button
                    ...
                    >{{ t('app.teams.delete.button') }}</Button
                >
            </div>
        </div>
    </div>
